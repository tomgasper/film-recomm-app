...
const handleSetFilmContext = (fetchInfo : FetchInfoType, setFetchInfo : ReactSetStateType, json : FilmInfoType) : void =>
{
...
const handleUnsuccesfulQuery = (setIsFetching : Function, err : any) : void => {
    setIsFetching(false);
    console.log(err);
}
